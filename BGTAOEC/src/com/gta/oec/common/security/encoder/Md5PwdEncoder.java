...
public class Md5PwdEncoder implements PwdEncoder {
	...
	private static final Log logger = LogFactory.getLog(Md5PwdEncoder.class);
	 ...
	 * 混淆码。防止破解。
	 */
	private String defaultSalt = "000000";
	...
	public static void main(String[] args) {
	   System.out.println(new Md5PwdEncoder().encodePassword("000000"));
	}
}
